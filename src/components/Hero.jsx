...
const Hero = ({ onRegisterClick }) => {
  ...
  return (
    <section id="home" className="relative min-h-[80vh] md:min-h-screen flex items-center justify-center pt-32 pb-8 md:pt-20 md:pb-8 overflow-hidden bg-grid-pattern">
      {/* Glow overlays */}
      ...
      <div className="relative z-10 text-center px-4 flex flex-col items-center">
        <img src="/logo2.png" alt="SIGNOVA Logo" className="h-20 md:h-28 w-auto mb-2 drop-shadow-[0_0_25px_rgba(34,211,238,0.4)] animate-pulse" />
        <p className="text-xs sm:text-sm md:text-lg text-white mb-1 font-mono font-bold tracking-wider drop-shadow-[0_0_8px_rgba(255,255,255,0.6)] md:whitespace-nowrap">
          University College of Engineering (BIT campus), Anna University, Tiruchirappalli - 24.
        </p>

        <p className="text-xs md:text-base text-cyan-400 mb-1 font-mono tracking-[0.2em] ml-[0.2em]">
        ...
        <p className="text-sm md:text-xl text-emerald-400 mb-2 md:mb-3 font-mono font-bold tracking-widest uppercase relative z-20 drop-shadow-[0_0_8px_rgba(52,211,153,0.5)]">
        ...
        <p className="text-sm md:text-base text-gray-400 mt-0 md:-mt-2 mb-3 md:mb-4 font-mono tracking-widest italic lowercase relative z-20">
          A Confluence of Talent and Technology
        </p>

        <div className="flex flex-col md:flex-row items-center justify-center gap-1 md:gap-3 mb-4 md:mb-6 drop-shadow-[0_0_15px_rgba(34,211,238,0.4)] relative z-20 mt-1 md:mt-2">
        ...
        <button 
          ...
          className="btn-primary text-base md:text-xl px-8 md:px-10 py-3 md:py-4 shadow-[0_0_20px_rgba(34,211,238,0.4)]"
        >
          Register Now!
        </button>
      </div>
